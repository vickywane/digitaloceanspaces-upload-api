...
-  Basic knowledge of [Golang](https://golang.org/). If you are new to Golang, this article provides an explanation of Golang, including how to configure your local machine for developing with Golang.

-   An understanding of [GraphQL](https://graphql.org/). You can learn more about GraphQL by starting with its schema definition through this article on [GraphQL SDL Refrence](https://www.digitalocean.com/community/tutorials/graphql-graphql-sdl).
 
-   An [Digitalocean account](https://www.digitalocean.com/), as several Digitalocean resources are used within this article.

-  [Git](https://git-scm.com/) installed and configured on your local machine.

## Step 1 — Bootstrapping a Golang GraphQL API

You would be using the [Gqlgen](https://github.com/99designs/gqlgen) package for creating a GraphQL API implemented in Golang.
